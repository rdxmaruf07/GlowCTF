...
import { checkConnection, useMySQL } from "./database";

const app = express();
app.use(express.json());
app.use(express.urlencoded({ extended: false }));

// Add middleware to check database connection before processing API requests
app.use(async (req, res, next) => {
  // Only check connection for API requests to avoid unnecessary checks
