...
const placeholderImage = "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1964&q=80";
      ...
      <div className="container mx-auto py-12 px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            The GlowCTF Arena platform was built by a passionate team of cybersecurity enthusiasts and developers.
            Each team member brings unique skills and expertise to create this comprehensive CTF training platform.
          </p>
        </div>
        ...
        <div className="mt-20 max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-6">
            GlowCTF Arena is a comprehensive Capture The Flag (CTF) cybersecurity training platform 
            designed to help security enthusiasts practice and improve their skills. The platform 
            features multi-level challenges across different security domains, AI-assisted learning, 
            team collaboration, and a badge achievement system.
          </p>
          <Button asChild>
