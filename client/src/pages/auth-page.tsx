      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <motion.div
                className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center text-primary mr-4 flex-shrink-0"
            ...
            >
              <motion.div
                className="w-10 h-10 rounded-full bg-accent/20 flex items-center justify-center text-accent mr-4 flex-shrink-0"
                whileHover={{ scale: 1.1, rotate: -5 }}
                transition={{ duration: 0.2 }}
              >
                <Code size={20} />
            ...
            >
              <motion.div
                className="w-10 h-10 rounded-full bg-green-500/20 flex items-center justify-center text-green-500 mr-4 flex-shrink-0"
                whileHover={{ scale: 1.1, rotate: 5 }}
                transition={{ duration: 0.2 }}
              >
        ...
        <motion.div variants={slideInRightVariants}>
          ...
          >
            <Card className="border-border shadow-xl bg-card/80 backdrop-blur-md hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300">
              <CardHeader>
