...
export const challenges = pgTable("challenges", {
  ...
  serviceUrl: text("service_url"), // For hosted challenges
  dockerImage: text("docker_image"), // For containerized challenges
  isActive: boolean("is_active").notNull().default(true),
  flagFormat: text("flag_format"), // Regex pattern for flag validation
...
// Challenge Files schema for file attachments
...
// Flag Submissions schema for tracking all attempts
